<section class="row">
    <div class="col-xs-12 <!--col-sm-offset-1 -->col-sm-8">
        <h1>People Say I Do Good Work</h1>
...
<section class="row">
    ...
    <div class="col-xs-12 col-sm-4 recommendation">
        ...
        <p class="jobTime">Fulbright Scholar</p>
        <p class="jobTime">Adventure Stage Ensemble Member</p>
        <p class="jobTime">Circumnavigator Scholar</p>

    </div>
    <div class="col-xs-12 col-sm-4  recommendation">
        <p>&ldquo;Nathan worked for me at Rush University Medical Center in the McCormick Educational Technology Center. We made numerous improvements to systems and processes over the 18 months I was there. Many of these improvements would not have gone so smoothly if it had not been for Nathan. He is very proactive in identifying potential problems and improvements. He does his own research and discovers potential solutions and then makes his suggestions. I always appreciated his willingness to be a strong member of our team.&rdquo;</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-xs-12 text-center">
                    <img src="images/fenchurch.gif" class="img-responsive modalImage" alt="An adorable kitten, Fenchurch, yawning.">
                </div>
