        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-xs-12 text-center">
                    <img src="images/ladderUpFig1.png" class="img-responsive modalImage" alt="presentation cover for our research project">
                </div>
...
<div class="modal fade" id="fig2Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-xs-12 text-center">
                    <img src="images/ladderUpFig2.png" class="img-responsive modalImage" alt="Ladder Up's volunteer form">
                </div>
...
<div class="modal fade" id="fig3Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-xs-12 text-center">
                    <img src="images/ladderUpFig3.png" class="img-responsive modalImage" alt="Some of the research questions we asked">
                </div>
...
<div class="modal fade" id="fig4Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-xs-12 text-center">
                    <img src="images/ladderUpFig4.png" class="img-responsive modalImage" alt="An example recomendation for Ladder Up.">
                </div>
